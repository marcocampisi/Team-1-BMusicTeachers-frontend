...
<template>
    ...
    <main class="mt-3 container">
        <div class="d-flex justify-content-center align-items-center">
            ...
            <div class="card-title">ANDREA PIANI <br>
        ...
        <div class="card m-2 my-5 w-50">
            <div class="m-3 row text-light text-justify">
                Mi Chiamo Andrea e con i miei bro , ingiustamente carcerati , Fra Marco e Mary , abbiamo deciso di creare questo inutile sito per provare a racimolare un po di grana per le nostre famiglie fuori dal carcere.
                Donate e comprate tante lezioni.
            </div>
        </div>
        <div class="card my-5">
            <div class="m-3 row text-light">
                Grazie Bro++++
            </div>
        </div>
        </div>
